...
Analysis of data from healthy adult participants, scanned on two 64 mT Hyperfine Swoop MRI systems, and a 3 T GE Premier MRI system.
...
seg_all = np.loadtxt('/Users/frantisek/Desktop/HYPE_in_progress/synthseg_labels_all.txt',dtype='str')
